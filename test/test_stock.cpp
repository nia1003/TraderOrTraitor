...
int main()
{
    ...
    unordered_map<string, array<int, 11>> price_per_round = 
    {
        ...
        {"UBER", {55, 55, 26, 29, 32, 48, 46, 46, 46, 46, 42}}, // 考慮要不要修正
        {"MRNA", {150, 150, 47, 66, 81, 136, 163, 163, 118, 93, 74}}, // 考慮要不要修正，有點跌太多
        ...
        {"UAL", {40, 44, 22, 22, 24, 35, 38, 38, 33, 30, 35}},
        {"DAL", {45, 50, 26, 26, 28, 41, 43, 43, 37, 34, 40}}
    };  
